...
//also on debain need sudo apt install libxft-dev
static const char *fonts[]          = { "JetBrains Mono Variable:size=11" };
static const char dmenufont[]       = "JetBrains Mono Variable:size=11";
...
//};
/*EM UPDATED COLOR SCHEME*/
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { s_base0, s_base03, s_base01 },      /* SchemeNorm dark */
	[SchemeSel]  = { s_base0, s_base02, s_base01 },      /* SchemeSel dark */
};
...
static const char *termcmd[]  = { "kitty", NULL };//alacritty-ligatures-git
